...
WHERE p.p_status = 'เปิดการขาย' AND p.p_name LIKE '%$q%' OR t.type_id LIKE '%q%'
...
<h2 class="mt-4">คำค้นหาสำหรับ "<?php echo $q?>"</h2>
</div>
<br>
    <div class="row">
...
<div class="col-sm-3" align="center" style="padding-bottom: 20px;">
    <div class="card border-Light mb-1" style="width: 16.5rem;">
        ...
        <div class="card-body">
            ...
            <br>
            ราคา <font color=""> <?php echo $row_prd["p_price_total"];?></font> บาท <br>
...
<div style="padding-top: 20px;">
    <nav aria-label="Page navigation example">
      <ul class="pagination justify-content-center">
        <li class="page-item">
            <a class="page-link" href="index.php?q=<?php echo $q?>&page=1" tabindex="-1" 
            aria-disabled="true">หน้าแรก</a></li>
        <li class="page-item <?=$page > 1 ? '': 'disabled' ?>"> 
        <a class="page-link" href="index.php?q=<?php echo $q?>&page=<?=$page-1?>" aria-label="Previous">
        ...
        <?php if($i <= 5): ?>
            ...
            href="index.php?q=<?php echo $q?>&page=<?=$i?>"><?=$i?></a></li>
        <?php endif; ?>
        <?php elseif($page > 2): ?>
        ...
        <li class="page-item <?=$page < $total_page ? '': 'disabled' ?>">
          <a class="page-link" href="index.php?q=<?php echo $q?>&page=<?=$page+1?>" aria-label="Next">
            <span aria-hidden="true">&raquo;</span>
          </a>
        </li>
        <li class="page-item"><a class="page-link" href="index.php?q=<?php echo $q?>&page=<?=$total_page?>">หน้าสุดท้าย</a>
        </li>
      </ul>
    </nav>
</div>
