...
echo ' <table id="example1" class="table table-bordered table-striped">';
  echo "<thead>";
    echo "<tr class=''>
      ...
      <th>ราคาสินค้า</th>
      <th width='10%' class='hidden-xs'>สถานะการขาย</th>  
       <th>จำนวนเข้าชม</th>
      <th width='7%'>แก้ไข</th>
    </tr>";
  echo "</thead>";
  ...
  echo "<tr>";
    ...
    echo "<td> ราคาจีน ".$row["p_price_cny"] ." หยวน".
       "<br>ราคาไทย ".$row["p_price_thb"] ." บาท".
       "<br>ค่านำเข้า ".$row["p_price_fee"] ." บาท".
       "<br>ราคารวม <font color='blue'>".$row["p_price_total"] ."</font>"." บาท".
      "</td> ";
      echo "<td class='hidden-xs' align='center'>";
      if ($row["p_status"] == 'เปิดการขาย') {
        echo "เปิดการขาย"."<br> <span class='label label-success'>(เปิด)</span>";
      }elseif($row["p_status"] == 'ปิดการขาย') {
        echo "ปิดการขาย"."<br> <span class='label label-danger'>(ปิด)</span>";
      }
    "</td> ";
