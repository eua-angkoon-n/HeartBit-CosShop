...
<form action="product_form_add_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
        <input type="number" name="p_price_cny" required class="form-control">
      </div>
    </div>
    <div class="form-group">
      <div class="col-sm-2 control-label">
      ...
      <div class="col-sm-1">
        <input type="number" name="p_price_fee" required class="form-control">
      </div>
    </div>
    <div class="form-group">
      <div class="col-sm-2 control-label">
      ...
      <div class="col-sm-1">
        <input type="number" name="p_deposit" required class="form-control">
      </div>
    </div>
