...
echo '<table id="example1" class="table table-bordered table-striped">';
  ...
  while($row = mysqli_fetch_array($result)) {
    ...
    ."<br>"."<a href='resetpass_admin.php?member_id=".$row['member_id']."'></a></td> ";
    echo "<td> ชื่อ ".$row["m_name"]
    ."</td> ";
    echo "<td>" .$row["m_address"] ."<br>Email.".$row["m_email"]. 
    ...
    . "</td> ";
       echo "<td class='hidden-xs' align='center'>";
        if ($st == 'admin') {
          ...
          echo "รอยืนยันอีเมล์"."<br> <span class='label label-warning'>(Verify)</span>";
        }
        echo "</td> ";
